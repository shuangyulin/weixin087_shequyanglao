	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`yonghuyiwanchengshixiang`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																if(this.ruleForm.id){
					await this.$api.update(`yonghuyiwanchengshixiang`, this.ruleForm);
				}else{
					await this.$api.add(`yonghuyiwanchengshixiang`, this.ruleForm);
				}
