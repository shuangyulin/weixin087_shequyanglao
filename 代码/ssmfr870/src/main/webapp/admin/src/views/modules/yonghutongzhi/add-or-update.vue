<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="通知类型" prop="tongzhileixing">
          <el-input v-model="ruleForm.tongzhileixing" 
              placeholder="通知类型" clearable  :readonly="ro.tongzhileixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="通知类型" prop="tongzhileixing">
              <el-input v-model="ruleForm.tongzhileixing" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.neirong = this.ruleForm.neirong.replace(reg,'../../../ssmfr870/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
