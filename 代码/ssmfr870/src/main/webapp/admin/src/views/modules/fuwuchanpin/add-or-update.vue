<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服务人员" prop="fuwurenyuan">
          <el-input v-model="ruleForm.fuwurenyuan" 
              placeholder="服务人员" clearable  :readonly="ro.fuwurenyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服务人员" prop="fuwurenyuan">
              <el-input v-model="ruleForm.fuwurenyuan" 
                placeholder="服务人员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="服务介绍" prop="fuwujieshao">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.fuwujieshao" label="服务介绍" prop="fuwujieshao">
                    <span>{{ruleForm.fuwujieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="服务人员介绍" prop="fuwurenyuanjieshao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="服务人员介绍"
                  v-model="ruleForm.fuwurenyuanjieshao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fuwurenyuanjieshao" label="服务人员介绍" prop="fuwurenyuanjieshao">
                    <span>{{ruleForm.fuwurenyuanjieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fuwujieshao = true;
          ...
          if(o=='fuwurenyuan'){
            this.ruleForm.fuwurenyuan = obj[o];
	    this.ro.fuwurenyuan = true;
            continue;
          }
          if(o=='fuwurenyuanjieshao'){
            this.ruleForm.fuwurenyuanjieshao = obj[o];
	    this.ro.fuwurenyuanjieshao = true;
            continue;
          }
          if(o=='tupian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.fuwuleixingOptions = "医疗服务,生活照料类服务".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
        url: `fuwuchanpin/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `fuwuchanpin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fuwuchanpinCrossAddOrUpdateFlag = false;
                  this.parent.search();
