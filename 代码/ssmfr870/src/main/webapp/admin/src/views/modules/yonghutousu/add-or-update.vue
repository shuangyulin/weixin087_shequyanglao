<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="服务人员" prop="fuwurenyuan">
          <el-select v-model="ruleForm.fuwurenyuan" placeholder="请选择服务人员">
            <el-option
                v-for="(item,index) in fuwurenyuanOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fuwushijian" label="服务时间" prop="fuwushijian">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="投诉详情" prop="tousuxiangqing">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="投诉详情"
                  v-model="ruleForm.tousuxiangqing" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tousuxiangqing" label="投诉详情" prop="tousuxiangqing">
                    <span>{{ruleForm.tousuxiangqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fuwushijian = true;
          ...
          if(o=='tousuxiangqing'){
            this.ruleForm.tousuxiangqing = obj[o];
	    this.ro.tousuxiangqing = true;
            continue;
          }
          if(o=='tupian'){
      ...
      this.$http({
		...
		if(json.shouji!=''&&json.shouji){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/fuwurenyuan/xingming`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.fuwurenyuanOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
