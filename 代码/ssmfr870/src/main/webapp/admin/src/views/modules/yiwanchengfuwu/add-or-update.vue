    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="服务状态" prop="fuwuzhuangtai">
          <el-select v-model="ruleForm.fuwuzhuangtai" placeholder="请选择服务状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="服务状态" prop="fuwuzhuangtai">
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.fuwuzhuangtaiOptions = "已完成".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
        url: `yiwanchengfuwu/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yiwanchengfuwu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yiwanchengfuwuCrossAddOrUpdateFlag = false;
                  this.parent.search();
